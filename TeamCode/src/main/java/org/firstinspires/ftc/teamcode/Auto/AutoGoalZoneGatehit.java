...
@Autonomous(name="Auto Goal Zone Gate Hit", group="Main")
@Config
public class AutoGoalZoneGatehit extends LinearOpMode {
    ...
    TrajectoryActionBuilder hitGate(TrajectoryActionBuilder builder){
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder toSpike1IntakeAndShoot = trajToShoot(hitGate(intakeFromSpike(toSpike1, 1)), false);

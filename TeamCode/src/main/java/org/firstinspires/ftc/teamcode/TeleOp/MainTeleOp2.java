...
@TeleOp(name="Main TeleOp 2", group="Main")
public class MainTeleOp2 extends OpMode {
    ...
    public void init(){
        ...
        double START_X = -58.0586;
        double START_Y = -40.7964;
        double START_HEADING = -128.71;
        Robot.drive.localizer.setPose(new Pose2d(START_X,
                Robot.alliance == Robot.Alliance.BLUE ? START_Y : -START_Y,
                Robot.alliance == Robot.Alliance.BLUE ? Math.toRadians(START_HEADING) : -Math.toRadians(START_HEADING)));

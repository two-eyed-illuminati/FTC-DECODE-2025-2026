...
public class Robot{
  ...
  public static double[] shootOuttake(Pose2d robotPose, PoseVelocity2d robotVelocity, boolean pid, double targetHeight){
    ...
    double maxOuttakeAngVelInitial = maxOuttakeAngVel/0.77;
    ...
    double minOuttakeAngVelInitial = minOuttakeAngVel/0.77;
    ...
    double targetOuttakeAngVelInitial = targetOuttakeAngVel/0.77;
  ...
  public static class ShootSequenceAction implements Action {
    ...
    public boolean run(@NonNull TelemetryPacket packet) {
      ...
      aimOuttakeTurret();
      double[] outtakeVels = shootOuttake(46.0);
